...
module.exports.initiateMixer = async (req, res, next) =>{
    try {
        ...
        if(await service.isTxnExists(txn_hash)) return res.apiError('This transaction hash has already been utilized for another receiver before', 400)
        ...
        const receiverRequestInDb = await service.getMixerRequestByCombination({receiver_address, txn_at: txn_object.txn_at})
